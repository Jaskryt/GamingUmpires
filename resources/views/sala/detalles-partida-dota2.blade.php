			...
			//fixture de los equipos
					switch ($salaDatos[0]->numero_Equipos) {
						...
						<table>
						    ...
						    <tr class="4">
								<td></td><td></td><td></td><td><button id="cuartos1vs2">Ver Detalles</button>
								<select id="matchc1vs2">'.$options.'</select></td>
								<td></td><td></td><td></td>
						    </tr>
						    <tr class="5">
						    ...
						    <tr class="12">
								<td></td><td></td><td></td><td><button id="cuartos3vs4">Ver Detalles</button>
						    ...
						    <tr class="14">
								<td></td><td><button id="octavose7ye8">Ver Detalles</button>
						...
						<table>
						    ...
						    <tr class="2">
						    	<td></td><td><button id="clasie1ye2">Ver Detalles</button>
						    	<select id="matchcl1vs2">'.$options.'</select></td>
						    	<td><input type="text" name="octavosFinal1" id="octavosFinal1" readonly="readonly" placeholder="Octavos de Final 1"
						    ...
						    <tr class="4">
						    	<td></td><td></td><td></td>
						    	<td><button id="octavose1ye2">Ver Detalles</button>
						    ...
						    <tr class="6">
						    	<td></td><td><button id="clasie3ye4">Ver Detalles</button>
						    	<select id="matchcl3vs4">'.$options.'</select></td>
						    	<td><input type="text" name="octavosFinal2" id="octavosFinal2" readonly="readonly" placeholder="Octavos de Final 1"
						    ...
						    <tr class="10">
						    	<td></td><td><button id="clasie5ye6">Ver Detalles</button>
						    	<select id="matchcl5vs6">'.$options.'</select></td>
						    	<td><input type="text" id="octavosFinal3" name="octavosFinal3" readonly="readonly" placeholder="Octavos de Final 2"
						    ...
						    <tr class="11">
						    	<td><input type="text" name="clasificacion6" id="clasificacion6" readonly="readonly"
							 	 			value="'.($encuentrosDatos[2]->equipo_2).'"></td>
						    	<td></td><td></td><td></td><td></td>
						    	<td><button id="cuartos1vs2">Ver Detalles</button>
						    	<select id="matchc1vs2">'.$options.'</select></td><td></td><td></td><td></td>
						    </tr>
						    <tr class="12">
						    	<td></td><td></td><td></td>
						    	<td><button id="octavose3ye4">Ver Detalles</button>
						    ...
						    <tr class="14">
						    	<td></td><td><button id="clasie7ye8">Ver Detalles</button>
						    	<select id="matchcl7vs8">'.$options.'</select></td>
						    	<td><input type="text" name="octavosFinal4" id="octavosFinal4" readonly="readonly" placeholder="Octavos de Final 2" value="'.($encuentrosDatos[9]->equipo_2).'"</td>
						    	<td></td><td></td><td></td><td></td><td></td><td></td>
						    </tr>
						    <tr class="15">
						    ...
						    <tr class="20">
						    	<td></td><td></td><td></td>
						    	<td><button id="octavose5ye6">Ver Detalles</button>
						    ...
						    <tr class="21">
						    	<td><input type="text" name="clasificacion11" id="clasificacion11" readonly="readonly"
							 	 			value="'.($encuentrosDatos[5]->equipo_1).'"></td>
						    	<td></td><td></td><td></td><td></td>
						    	<td><button id="cuartos3vs4">Ver Detalles</button>
						    	<select id="matchc3vs4">'.$options.'</select></td><td></td><td></td><td></td>
						    </tr>
						    <tr class="22">
						    	<td></td><td><button id="clasie11ye12">Ver Detalles</button>
						    	<select id="matchcl11vs12">'.$options.'</select></td>
						    	<td><input type="text" name="octavosFinal6" id="octavosFinal6" readonly="readonly" placeholder="Octavos de Final 3"
						    ...
						    <tr class="26">
						    	<td></td><td><button id="clasie13ye14">Ver Detalles</button>
						    	<select id="matchcl13vs14">'.$options.'</select></td>
						    	<td><input type="text" name="octavosFinal7" id="octavosFinal7" readonly="readonly" placeholder="Octavos de Final 4"
						    ...
						    <tr class="28">
						    	<td></td><td></td><td></td>
						    	<td><button id="octavose7ye8">Ver Detalles</button>
						    ...
						    <tr class="30">
						    	<td></td><td><button id="clasie15ye16">Ver Detalles</button>
						    	<select id="matchcl15vs16">'.$options.'</select></td>
						    	<td><input type="text" name="octavosFinal8" id="octavosFinal8" readonly="readonly" placeholder="Octavos de Final 4"
