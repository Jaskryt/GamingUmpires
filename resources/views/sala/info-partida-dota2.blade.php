	...
	<section><center>
		...
		<?php
			$salaTable = DB::table('sala_dota_2')
                        ...
                        ->get();
             echo "<h2>MODO DE JUEGO: ".$salaTable[0]->modo_Juego."</h2>";
             echo "<h3>Ganador: <select id='teamWinner'>
		...
		<div class="container-fluid creacion-sala">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block">
					<h2>{{ $encuentrosTable[0]->equipo_1 }}</h2>
					kills Totales: <input type="number" name="killsequipo1" class="cajasT">
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block ">
					<h2>{{ $encuentrosTable[0]->equipo_2}}</h2>
					kills Totales: <input type="number" name="killsequipo2" class="cajasT">
				</div>
			</div>
		</div>
		<div class="player1teams">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-non d-md-block team1">
					<?php 
						$jugadorTable = DB::table('jugadores_dota_2')
                        				->where("id","=",$infoTable[0]->codigo_Jugador)   
                        				->get();
                       echo "<input type='text' readonly value=".$jugadorTable[0]->nickname."><br>";
					?>
					<img class="imagen-redonda"  width="150" height="150"  
					id="imgjugador1"   src={{ $heros[$infoTable[0]->personaje]["img"] }} >
					<select id="heroj1t1" name="heroj1t1" onchange="verIndex('heroj1t1','imgjugador1')">
					<option value="{{$infoTable[0]->personaje}}">
						<?php echo $heros[$infoTable[0]->personaje]["localized_name"]; ?></option>
					<?php echo $listaHeros; ?></select>
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					<?php 
						$jugadorTable = DB::table('jugadores_dota_2')
					...
					<select id="heroj1t2" name="heroj1t2" onchange="verIndex('heroj1t2','imgjugador6')">
					<option value="{{$infoTable[5]->personaje}}">
						<?php echo $heros[$infoTable[5]->personaje]["localized_name"]; ?></option>
					<?php echo $listaHeros; ?></select>
				</div>
				
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team1">
						nivel:<input type="number" name="nivelj1t1" value="{{ $infoTable[0]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj1t1" value="{{ $infoTable[0]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj1t1" value="{{ $infoTable[0]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj1t1" value="{{ $infoTable[0]->asistencias}}" class="cajasN">
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team2">
						nivel:<input type="number" name="nivelj1t2" value="{{ $infoTable[5]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj1t2" value="{{ $infoTable[5]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj1t2" value="{{ $infoTable[5]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj1t2" value="{{ $infoTable[5]->asistencias}}" class="cajasN">
				</div>
			</div>			
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team1">
					items:
					<select id="itemj1t1" onchange="verItems('1','itemj1t1')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j1" name="rbj1">
								<input type="hidden" name="img1txtj1" id="img1txtj1" value={{ $infoTable[0]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j1"
							...
							<td><input type="radio" id="slot2j1" name="rbj1">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j1"
							...
							<td><input type="radio" id="slot3j1" name="rbj1">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j1"
							...
							<td><input type="radio" id="slot0j1" name="rbj1">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j1"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j1"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j1"
							...
							<td><input type="radio" id="slot6j1" name="rbj1">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j1"
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					items:
					<select id="itemj1t2" onchange="verItems('6','itemj1t2')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j6" name="rbj6">
								<input type="hidden" name="img1txtj6" id="img1txtj6" value={{ $infoTable[5]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j6"
							...
							<td><input type="radio" id="slot2j6" name="rbj6">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j6"
							...
							<td><input type="radio" id="slot3j6" name="rbj6">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j6"
							...
							<td><input type="radio" id="slot0j6" name="rbj6">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j6"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j6"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j6"
							...
							<td><input type="radio" id="slot6j6" name="rbj6">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j6"
		...
		<div class="player2teams">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-non d-md-block team1">
					...
					<select id="heroj2t1" name="heroj2t1" onchange="verIndex('heroj2t1','imgjugador2')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					...
					<select id="heroj2t2" name="heroj2t2" onchange="verIndex('heroj2t2','imgjugador7')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team1">
						nivel:<input type="number" name="nivelj2t1" value="{{ $infoTable[1]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj2t1" value="{{ $infoTable[1]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj2t1" value="{{ $infoTable[1]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj2t1" value="{{ $infoTable[1]->asistencias}}" class="cajasN">
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team2">
						nivel:<input type="number" name="nivelj2t2" value="{{ $infoTable[6]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj2t2" value="{{ $infoTable[6]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj2t2" value="{{ $infoTable[6]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj2t2" value="{{ $infoTable[6]->asistencias}}" class="cajasN">
				</div>
			</div>			
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team1">
					items:
					<select id="itemj2t1" onchange="verItems('2','itemj2t1')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j2" name="rbj2">
								<input type="hidden" name="img1txtj2" id="img1txtj2" value={{ $infoTable[1]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j2"
							...
							<td><input type="radio" id="slot2j2" name="rbj2">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j2"
							...
							<td><input type="radio" id="slot3j2" name="rbj2">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j2"
							...
							<td><input type="radio" id="slot0j2" name="rbj2">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j2"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j2"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j2"
							...
							<td><input type="radio" id="slot6j2" name="rbj2">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j2"
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					items:
					<select id="itemj2t2" onchange="verItems('7','itemj2t2')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j7" name="rbj7">
								<input type="hidden" name="img1txtj7" id="img1txtj7" value={{ $infoTable[6]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j7"
							...
							<td><input type="radio" id="slot2j7" name="rbj7">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j7"
							...
							<td><input type="radio" id="slot3j7" name="rbj7">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j7"
							...
							<td><input type="radio" id="slot0j7" name="rbj7">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j7"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j7"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j7"
							...
							<td><input type="radio" id="slot6j7" name="rbj7">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j7"
		...
		<div class="player3teams">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-non d-md-block team1">
					...
					<select id="heroj3t1" name="heroj3t1" onchange="verIndex('heroj3t1','imgjugador3')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					...
					<select id="heroj3t2" name="heroj3t2" onchange="verIndex('heroj3t2','imgjugador8')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team1">
						nivel:<input type="number" name="nivelj3t1" value="{{ $infoTable[2]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj3t1" value="{{ $infoTable[2]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj3t1" value="{{ $infoTable[2]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj3t1" value="{{ $infoTable[2]->asistencias}}" class="cajasN">
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team2">
						nivel:<input type="number" name="nivelj3t2" value="{{ $infoTable[7]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj3t2" value="{{ $infoTable[7]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj3t2" value="{{ $infoTable[7]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj3t2" value="{{ $infoTable[7]->asistencias}}" class="cajasN">
				</div>
			</div>			
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team1">
					items:
					<select id="itemj3t1" onchange="verItems('3','itemj3t1')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j3" name="rbj3">
								<input type="hidden" name="img1txtj3" id="img1txtj3" value={{ $infoTable[2]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j3"
							...
							<td><input type="radio" id="slot2j3" name="rbj3">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j3"
							...
							<td><input type="radio" id="slot3j3" name="rbj3">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j3"
							...
							<td><input type="radio" id="slot0j3" name="rbj3">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j3"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j3"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j3"
							...
							<td><input type="radio" id="slot6j3" name="rbj3">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j3"
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					items:
					<select id="itemj3t2" onchange="verItems('8','itemj3t2')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j8" name="rbj8">
								<input type="hidden" name="img1txtj8" id="img1txtj8" value={{ $infoTable[7]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j8"
							...
							<td><input type="radio" id="slot2j8" name="rbj8">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j8"
							...
							<td><input type="radio" id="slot3j8" name="rbj8">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j8"
							...
							<td><input type="radio" id="slot0j8" name="rbj8">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j8"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j8"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j8"
							...
							<td><input type="radio" id="slot6j8" name="rbj8">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j8"
		...
		<div class="player4teams">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-non d-md-block team1">
					...
					<select id="heroj4t1" name="heroj4t1" onchange="verIndex('heroj4t1','imgjugador4')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					...
					<select id="heroj4t2" name="heroj4t2" onchange="verIndex('heroj4t2','imgjugador9')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team1">
						nivel:<input type="number" name="nivelj4t1" value="{{ $infoTable[3]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj4t1" value="{{ $infoTable[3]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj4t1" value="{{ $infoTable[3]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj4t1" value="{{ $infoTable[3]->asistencias}}" class="cajasN">
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team2">
						nivel:<input type="number" name="nivelj4t2" value="{{ $infoTable[8]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj4t2" value="{{ $infoTable[8]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj4t2" value="{{ $infoTable[8]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj4t2" value="{{ $infoTable[8]->asistencias}}" class="cajasN">
				</div>
			</div>			
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team1">
					items:
					<select id="itemj4t1" onchange="verItems('4','itemj4t1')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j4" name="rbj4">
								<input type="hidden" name="img1txtj4" id="img1txtj4" value={{ $infoTable[3]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j4"
							...
							<td><input type="radio" id="slot2j4" name="rbj4">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j4"
							...
							<td><input type="radio" id="slot3j4" name="rbj4">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j4"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j4"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j4"
							...
							<td><input type="radio" id="slot6j4" name="rbj4">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j4"
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					items:
					<select id="itemj4t2" onchange="verItems('9','itemj4t2')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j9" name="rbj9">
								<input type="hidden" name="img1txtj9" id="img1txtj9" value={{ $infoTable[8]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j9"
							...
							<td><input type="radio" id="slot2j9" name="rbj9">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j9"
							...
							<td><input type="radio" id="slot3j9" name="rbj9">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j9"
							...
							<td><input type="radio" id="slot0j9" name="rbj9">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j9"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j9"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j9"
							...
							<td><input type="radio" id="slot6j9" name="rbj9">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j9"
		...
		<div class="player5teams">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-non d-md-block team1">
					...
					<select id="heroj5t1" name="heroj5t1" onchange="verIndex('heroj5t1','imgjugador5')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					...
					<select id="heroj5t2" name="heroj5t2" onchange="verIndex('heroj5t2','imgjugador10')">
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team1">
						nivel:<input type="number" name="nivelj5t1" value="{{ $infoTable[4]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj5t1" value="{{ $infoTable[4]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj5t1" value="{{ $infoTable[4]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj5t1" value="{{ $infoTable[4]->asistencias}}" class="cajasN">
				</div>
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none d-none  d-md-block team2">
						nivel:<input type="number" name="nivelj5t2" value="{{ $infoTable[9]->nivel }}" class="cajasN"><br>
						K:<input type="number" name="asesinatosj5t2" value="{{ $infoTable[9]->asesinatos}}" class="cajasN">
						D:<input type="number" name="muertesj5t2" value="{{ $infoTable[9]->muertes }}" class="cajasN">
						A:<input type="number" name="asistenciasj5t2" value="{{ $infoTable[9]->asistencias}}" class="cajasN">
				</div>
			</div>			
			<div class="row">
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team1">
					items:
					<select id="itemj5t1" onchange="verItems('5','itemj5t1')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j5" name="rbj5">
								<input type="hidden" name="img1txtj5" id="img1txtj5" value={{ $infoTable[4]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j5"
							...
							<td><input type="radio" id="slot2j5" name="rbj5">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j5"
							...
							<td><input type="radio" id="slot3j5" name="rbj5">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j5"
							...
							<td><input type="radio" id="slot0j5" name="rbj5">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j5"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j5"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j5"
							...
							<td><input type="radio" id="slot6j5" name="rbj5">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j5"
				...
				<div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-6 d-none  d-md-block team2">
					items:
					<select id="itemj5t2" onchange="verItems('10','itemj5t2')"><?php echo $listaItems; ?></select>
					<table>
						<tr>
							<td><input type="radio" id="slot1j10" name="rbj10">
								<input type="hidden" name="img1txtj10" id="img1txtj10" value={{ $infoTable[9]->slot1 }}>
								<img class="imagen-redonda"  width="100" height="100" id="imgitem1j10"
							...
							<td><input type="radio" id="slot2j10" name="rbj10">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem2j10"
							...
							<td><input type="radio" id="slot3j10" name="rbj10">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem3j10"
							...
							<td><input type="radio" id="slot0j10" name="rbj10">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem0j10"
						...
						<tr>
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem4j10"
							...
							<td>
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem5j10"
							...
							<td><input type="radio" id="slot6j10" name="rbj10">
								...
								<img class="imagen-redonda"  width="100" height="100" id="imgitem6j10"
